...
class EmployeeController extends Controller
{
    ...
    public function generateSalarySlipBulk(Request $request, $outletId)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'employees.*.allowance_details.*.salary_component_id'  => 'nullable|integer|exists:salary_components,id',
            'employees.*.allowance_details.*.name'                  => 'required_with:employees.*.allowance_details|string|max:255',
            ...
            'employees.*.deduction_details.*.salary_component_id'  => 'nullable|integer|exists:salary_components,id',
            'employees.*.deduction_details.*.name'                  => 'required_with:employees.*.deduction_details|string|max:255',
